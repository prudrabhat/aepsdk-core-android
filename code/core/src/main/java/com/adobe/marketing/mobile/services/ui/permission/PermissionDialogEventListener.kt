...
package com.adobe.marketing.mobile.services.ui.permission
...
interface PermissionDialogEventListener : PresentationEventListener<PermissionDialog> {
    /**
     * Called when the user grants the permission.
     */
